...
const TRANSLATIONS = {
  ...
  fr: { dashboard: 'Tableau de Bord', crowdManagement: 'Gestion des Foules', navigation: 'Navigation Intelligente', sustainability: 'Durabilité', transport: 'Hub Transport', emergency: 'Réponse d\'Urgence', settings: 'Paramètres', liveData: 'EN DIRECT', totalAttendance: 'Fréquentation Totale', capacity: 'Capacité du Stade', activeAlerts: 'Alertas Actives', avgWait: 'Temps d\'Attente Moyen', search: 'Rechercher dans le stade...' },
